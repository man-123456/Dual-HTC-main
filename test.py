...
parser.add_argument('--name', type=str, default='wos-train3-ZLPR-Graphormer-Lamb1=1-Labm2=0.5-lr=2e-5', help='Name of checkpoint. Commonly as DATASET-NAME.') #required=True
parser.add_argument('--extra', default='_micro', choices=['_macro', '_micro'], help='An extra string in the name of checkpoint.')
parser.add_argument('--label_cpt', type=str, default='data/wos/wos.taxonomy', help='Label hierarchy file.')
...
if __name__ == '__main__':
    ...
    model = ContrastModel.from_pretrained('./PretrainedModel/bert-base-uncased',
                                          ...
                                          lamb=args.lamb, threshold=args.thre, label_cpt=args.label_cpt)
